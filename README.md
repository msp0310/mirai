...
```bash
git clone https://github.com/msp0310/compass.git
cd compass
...
[http://127.0.0.1:8080/](http://127.0.0.1:8080/) を開きます。SQLiteのデータは`compass-data`ボリュームに保存されます。
